...
package OpenFile is
    ...
    procedure ecriture(Tab_Huff : in T_Tab_Huff; Liste_binaire : in T_Tab_symbole; Tab_texte : in T_Tab_symbole; Tab_octet_compress : in T_tab; File_Name : in String);

    procedure lecture(Tab_Texte : out T_Tab_symbole; Tab_octet : out T_Tab; Tab_arbre :out T_Tab_symbole; File_Name : in String);

    procedure ecriture_decompress(texte : T_Tab_symbole;File_Name : in String );
end OpenFile;
