...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_exemple_dates_erreurs" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8cbad017#;
   pragma Export (C, u00001, "exemple_dates_erreursB");
