...
begin
    ...
    --Afficher_Deux_Positions (2); --cette fonction n'est pas accéssible par l'utilisateur
    New_Line;
    ...
    --Une_Date.Jour := 15;  --T_Date a été défini comme privée, l'utilisateur ne peut donc pas modififer ses valeurs
    --Une_Date.Mois := Mois_Suivant; --même chose
    Afficher (Une_Date);
    New_Line;
