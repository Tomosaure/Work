...
procedure Exemples_Memoire_Dynamique is
	...
	begin
        ...
        Ptr1.all := 5;
        Ptr2.all := Ptr1.all;
        Put_Line ("Ptr2.all2 = " & Integer'Image (Ptr2.all));
    ...
    -- il est plus prudent de ne pas associer un pointeur qui n'est pas alloué à un pointeur qui
    -- l'est et qui est ammené à être libéré
