...
expressions : unaires expression
			| unaires expression binaire expresions
...
suffixes :  | suffixe suffixes

suffixe : CROOUV expression CROFER
		  | PAROUV PARFER
		  | PAROUV expressionvirgule PARFER

expressionvirgule : expression
					| expression VIRG expressionvirgule
%%
