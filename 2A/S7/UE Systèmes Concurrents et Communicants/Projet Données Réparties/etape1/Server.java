...
public class Server extends UnicastRemoteObject implements Server_itf {
    ...
    // méthode pour incrementer l'identifiant à chaque appel et ainsi fournir un identifiant unique à chaque objet partagé
    ...
    public int create(Object o) throws RemoteException {
        ...
        incrementer();
        // on crée l'objet avec l'identifiant unique
        ServerObject servObj = new ServerObject(o, identifiant);
        // on ajoute l'objet partagé dans le HashMap
