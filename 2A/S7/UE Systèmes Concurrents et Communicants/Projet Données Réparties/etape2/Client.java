...
////////////////////////////////////////////////////////////
	...
	// méthode permettant de créer un Stub à partir d'un objet et de son id
	public static SharedObject StubCreator (Object obj, int id) {
		SharedObject shared_obj = null;
		try {
			// On récupère la classe stub associé à l'objet
			Class<?> c = Class.forName(obj.getClass().getName()+"_stub");
			// On récupère le constructeur pour pouvoir créer une instance
